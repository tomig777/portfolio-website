    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          p.z = (sin(p.x * 4.0) * 1.5 + cos(p.y * 2.0) * 1.5) * (uSpeed * 0.5);
...
class App {
  constructor(
    ...
    this.scroll = { ease: scrollEase, current: 10000, target: 10000, last: 10000 };
...
export default function CircularGallery({
  ...
  return (
    <div className="circular-gallery" style={{ width: '100%', height: '100%', position: 'relative' }}>
