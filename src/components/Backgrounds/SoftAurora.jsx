...
void main() {
  ...
  col += 0.99 * auroraGlow(t + uLayerOffset, shift) * cosineGradient(uv.x + uTime * uSpeed * 0.1 * uColorSpeed, vec3(2.0, 1.0, 0.0), vec3(0.5), vec3(0.5), vec3(0.5, 0.20, 0.25)) * uColor2;
