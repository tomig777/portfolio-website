  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uNoise: { value: initialSettings.noiseIntensity },
        uScan: { value: initialSettings.scanlineIntensity },
        uScanFreq: { value: initialSettings.scanlineFrequency },
        uWarp: { value: initialSettings.warpAmount }
      }
    });
